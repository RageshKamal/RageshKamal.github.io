...
const Skills = () => {
  const skillsData = [
    { icon: FaHtml5, text: "Azure" },
    { icon: FaCss3Alt, text: "AWS" },
    { icon: FaJsSquare, text: "Docker" },
    { icon: FaGithub, text: "Kubernetes" },
    { icon: FaNodeJs, text: "Terraform" },
    { icon: FaNodeJs, text: "Git" },
    { icon: SiCypress, text: "Windows" },
    { icon: FaDatabase, text: "Linux" },
    { icon: FaReact, text: "Networking" },
    { icon: FaReact, text: "MS Office" },
