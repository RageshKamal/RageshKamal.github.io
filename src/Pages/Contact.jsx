...
const Contact = () => {
  const contactData = [
    ...
    },
    {
      ...
      heading: "Email",
      subheading: (
        <a className="socialMediaLinksToPage" href="mailto:rageshkamal7@gmail.com">
          rageshkamal7@gmail.com
        </a>
      ),
    },
    {
      ...
      heading: "Phone",
      subheading: (
        <a className="socialMediaLinksToPage" href="tel:6369436903">
          +91-6369436903
        </a>
      ),
    },
    ...
    // },
    {
      ...
      subheading: (
        <a
          className="socialMediaLinksToPage"
          href="https://www.linkedin.com/in/rageshkamal/"
          target="_blank"
          rel="noopener noreferrer"
        >
          rageshkamal
    ...
    },
    {
      icon: <Icon as={FaMapMarkerAlt} boxSize={7} color="blue.500" />,
      heading: "Address",
      subheading: "Bengaluru, Karnataka",
    },
  ];
  return (
    <Box
